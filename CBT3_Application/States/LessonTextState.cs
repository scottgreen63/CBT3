...
public class LessonTextState : BaseState
{
    private LessonPage _lessonpage;
    private Lesson _lesson;
    private LessonPageMachine _parentMachine;

    public LessonTextState(IMediator mediator, IMessenger messenger, LessonPage lessonpage, Lesson lesson, LessonPageMachine parentMachine) : base(mediator, messenger)
    {
