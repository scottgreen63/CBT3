...
namespace CBT3_Domain.Common;
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BaseResult"/> class with the specified parameters.
        /// </summary>
        ...
        /// <summary>
        /// Returns a success <see cref="BaseResult"/>.
        /// </summary>
        ...
        /// <summary>
        /// Returns a failure <see cref="BaseResult"/> with the specified error.
        /// </summary>
        /// <param name="error">The error.</param>
        /// <returns>A new instance of <see cref="BaseResult"/> with the specified error and failure flag set.</returns>
    ...
    public class Result<TValue> : Result
        {
            ...
            /// <exception cref="InvalidOperationException"> when <see cref="BaseResult.IsFailure"/> is true.</exception>
